...
/**
 * We reserve more heavy-duty insertion testing for HeapFile and HeapPage. This
 * suite is superficial.
 */
public class InsertTest extends TestUtil.CreateHeapFile {
	...
	public void getNext() throws Exception {
		Insert op = new Insert(tid, scan1, empty.getId());
		op.open();
		assertTrue(TestUtil.compareTuples(Utility.getHeapTuple(7, 1), // the
																		// length
																		// of
																		// scan1
				op.next()));
