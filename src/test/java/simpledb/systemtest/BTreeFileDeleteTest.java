...
public class BTreeFileDeleteTest extends SimpleDbTestBase {
	...
	public void testRedistributeLeafPages() throws Exception {
		...
		// deleting a tuple now should bring the page below minimum occupancy
		// and cause
	...
	public void testMergeLeafPages() throws Exception {
		// This should create a B+ tree with one full page and two half-full
		// leaf pages
	...
	public void testReuseDeletedPages() throws Exception {
		...
		// now there should be 2 leaf pages, 1 internal page, 1 unused leaf
		// page, 1 header page
	...
	public void testRedistributeInternalPages() throws Exception {
		...
		Database.resetBufferPool(bf.numPages() + 1); // we need more pages for
														// this test
	...
	public void testDeleteInternalPages() throws Exception {
		...
		// Delete tuples causing leaf pages to merge until the first internal
		// page
		// gets below minimum occupancy and causes the entries to be
		// redistributed
		count = 0;
		while (count < 62) {
			assertEquals(count, leftChild.getNumEmptySlots());
