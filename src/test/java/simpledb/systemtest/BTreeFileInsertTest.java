...
public class BTreeFileInsertTest extends SimpleDbTestBase {
	...
	public void addTuple() throws Exception {
		// create an empty B+ tree file keyed on the second field of a 2-field
		// tuple
	...
	public void addDuplicateTuples() throws Exception {
		...
		for (int i = 0; i < 5; ++i) {
			for (int j = 0; j < 600; ++j) {
				tup = BTreeUtility.getBTreeTuple(i, 2);
				empty.insertTuple(tid, tup);
				// BTreeChecker.checkRep(empty, tid, new HashMap<PageId,
				// Page>(), true);
			}
	...
	public void testSplitRootPage() throws Exception {
		...
		// There are 503 keys per internal page (504 children) and 502 tuples
		// per leaf page
		// 504 * 502 = 253008
	...
	public void testSplitInternalPage() throws Exception {
		...
		// This should create a B+ tree with a packed second tier of internal
		// pages
