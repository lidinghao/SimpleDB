...
public class SystemTestUtil {
	 ...
	 * ret[0] is true if the sequence is quadratic ret[1] is the common
	 * difference of the sequence if ret[0] is true.
	 * 
	 * @param sequence
	 * @return ret[0] = true if sequence is qudratic(or sub-quadratic or
	 *         linear), ret[1] = the coefficient of n^2
	 */
	 ...
	 * ret[0] is true if the sequence is linear ret[1] is the common difference
	 * of the sequence if ret[0] is true.
	 * 
	 * @param sequence
	 * @return ret[0] = true if sequence is linear, ret[1] = the common
	 *         difference
	 */
