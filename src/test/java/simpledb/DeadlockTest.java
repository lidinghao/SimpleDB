...
public class DeadlockTest extends TestUtil.CreateHeapFile {
	...
	/**
	 * Not-so-unit test to construct a deadlock situation. t1 acquires p0.read;
	 * t2 acquires p1.read; t1 attempts p1.write; t2 attempts p0.write. Rinse
	 * and repeat.
	 */
	@Test
	...
	/**
	 * Not-so-unit test to construct a deadlock situation. t1 acquires p0.read;
	 * t2 acquires p0.read; t1 attempts to upgrade to p0.write; t2 attempts to
	 * upgrade to p0.write
	 */
	@Test
