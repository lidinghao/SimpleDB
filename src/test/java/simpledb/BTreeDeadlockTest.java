...
public class BTreeDeadlockTest extends SimpleDbTestBase {
	...
	public void setUp() throws Exception {
		...
		// this is the number of tuples we must insert to replace the deleted
		// tuples
	 ...
	 * 
	 * This test causes two different transactions to update two (probably)
	 * different leaf nodes Each transaction can happily insert tuples until the
	 * page fills up, but then it needs to obtain a write lock on the root node
	 * in order to split the page. This will cause a deadlock situation.
	 */
	@Test
