 ...
 * and implements the Page interface that is used by BufferPool.
 *
 * @see BTreeFile
 * @see BufferPool
 *
...
public class BTreeInternalPage extends BTreePage {
	...
	public int getMaxEntries() {
		...
		int entriesPerPage = (BufferPool.getPageSize() * 8 - extraBits) / bitsPerEntryIncludingHeader; // round
																										// down
	 ...
	 * 
	 * @throws DbException
	 *             if this entry is not on this page, or entry slot is already
	 *             empty.
	 * @param e
	 *            The entry to delete
	 * @param deleteRightChild
	 *            - if true, delete the right child. Otherwise delete the left
	 *            child
	 */
	 ...
	 * 
	 * @param e
	 *            - the entry with updated key and/or child pointers
	 * @throws DbException
	 *             if this entry is not on this page, entry slot is already
	 *             empty, or updating this key would put the entry out of order
	 *             on the page
	 */
	 ...
	 * 
	 * @throws DbException
	 *             if the page is full (no empty slots) or key field type, table
	 *             id, or child page category is a mismatch, or the entry is
	 *             invalid
	 * @param e
	 *            The entry to add.
	 */
	 ...
	 * 
	 * @param i
	 *            - the index of the child page id
