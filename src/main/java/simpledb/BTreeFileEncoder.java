...
public class BTreeFileEncoder {
	 ...
	 * 
	 * @param tuples
	 *            - list of tuples to add to the file
	 * @param hFile
	 *            - the file to temporarily store the data as a heap file on
	 *            disk
	 * @param bFile
	 *            - the file on disk to back the resulting BTreeFile
	 * @param keyField
	 *            - the index of the key field for this B+ tree
	 * @param numFields
	 *            - the number of fields in each tuple
	 ...
	 * 
	 * @param inFile
	 *            - the raw text file containing the tuples
	 * @param hFile
	 *            - the file to temporarily store the data as a heap file on
	 *            disk
	 * @param bFile
	...
	public static class TupleComparator implements Comparator<Tuple> {
		 ...
		 * 
		 * @param keyField
		 *            - the index of the field the tuples are keyed on
		 */
	 ...
	 * @param typeAr
	 *            - array containing the types of the tuples
	 * @param fieldSeparator
	 *            - character separating fields in the raw data file
	 * @param keyField
	 *            - the field of the tuples the B+ tree will be keyed on
	 * @return the BTreeFile
	 */
	 ...
	 * @param hFile
	 *            - the data file for the HeapFile to be used as an intermediate
	 *            conversion step
	 * @param bFile
	 *            - the data file for the BTreeFile
	 * @param npagebytes
	 *            - number of bytes per page
	 * @param numFields
	 *            - number of fields per tuple
	...
	public static BTreeFile convert(File inFile, File hFile, File bFile, int npagebytes, int numFields, Type[] typeAr,
		...
		int nrecords = (npagebytes * 8 - leafpointerbytes * 8) / (nrecbytes * 8 + 1); // floor
																						// comes
																						// for
																						// free
		...
		int nentries = (npagebytes * 8 - internalpointerbytes * 8 - 1) / (nentrybytes * 8 + 1); // floor
																								// comes
																								// for
																								// free
	 ...
	 *            - the BTreeFile
	 * @param pid
	 *            - the id of the page to update with the right sibling pointer
	 * @param rightSiblingId
	 *            - the id of the page's right sibling
	 * @throws IOException
	 * @throws DbException
	 */
	 ...
	 *            - the BTreeFile
	 * @param pid
	 *            - id of the page to update with the parent pointer
	 * @param parent
	 ...
	 * @param tableid
	 *            - the table id of this BTreeFile
	 * @param keyField
	 ...
	 *            - the new entry
	 * @param level
	 *            - the level of the new entry (0 is closest to the leaf pages)
	 * @param nentries
	 *            - number of entries per page
	 * @param npagebytes
	 *            - number of bytes per page
	 ...
	 *            - the category of the child pages (either internal or leaf)
	 ...
	 * @param rootCategory
	 *            - the category of the root page (leaf or internal)
	 * @param header
	 *            - the page number of the first header page
