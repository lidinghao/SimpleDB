...
public class BTreeHeaderPage implements Page {
	...
	/**
	 * Create a BTreeHeaderPage from a set of bytes of data read from disk. The
	 * format of a BTreeHeaderPage is two pointers to the next and previous
	 * header pages, followed by a set of bytes indicating which pages in the
	 * file are used or available
	 * 
	 ...
	 * generated by getPageData to the BTreeHeaderPage constructor and have it
	 * produce an identical BTreeHeaderPage object.
	 *
	 * @see #BTreeHeaderPage
	 ...
	 * BTreeHeaderPage. Used to add new, empty pages to the file. Passing the
	 * results of this method to the BTreeHeaderPage constructor will create a
	 * BTreeHeaderPage with no valid data in it.
	 *
	 ...
	 * 
	 * @param id
	 *            - the page id of the previous header page
	 * @throws DbException
	 */
	 ...
	 * 
	 * @param id
	 *            - the page id of the next header page
	 * @throws DbException
	 */
