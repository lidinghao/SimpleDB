...
public class BTreeUtility {
	 ...
	 *            - number of rows
	 * @param maxValue
	 *            - the maximum random value in this B+ tree
	 * @param columnSpecification
	 *            - optional column specification
	 * @param tuples
	 *            - optional list of tuples to return
	 * @param keyField
	 ...
	 *            - number of rows
	 * @param minValue
	 *            - the minimum random value in this B+ tree
	 * @param maxValue
	 *            - the maximum random value in this B+ tree
	 * @param columnSpecification
	 *            - optional column specification
	 ...
	 * @param childPointers
	 *            - list of child pointers to return
	 * @param keys
	 ...
	 * @param tableid
	 *            - the tableid
	 * @param childPageCategory
	 *            - the child page category (LEAF or INTERNAL)
	 * @param minKey
	 *            - the minimum key value
	 * @param maxKey
	 *            - the maximum key value
	...
	/**
	 * Get the number of tuples that can fit on a page with the specified number
	 * of integer fields
	 * 
	 * @param columns
	 ...
	 * 
	 * @param pid
	 *            - the page id of the leaf page
	 * @param columns
	 *            - the number of fields per tuple
	 * @param keyField
	 *            - the index of the key field in each tuple
	 * @param min
	 *            - the minimum value
	 * @param max
	 *            - the maximum value
	 ...
	 * 
	 * @param pid
	 *            - the page id of the internal page
	 * @param keyField
	 *            - the index of the key field in each tuple
	 * @param childPageCategory
	 *            - the child page category (LEAF or INTERNAL)
	 ...
	 * @param keyField
	 *            the field the B+ tree is keyed on
	...
	/**
	 * A utility method to create a new BTreeFile with no data, assuming the
	 * path does not already exist. If the path exists, the file will be
	 * overwritten. The new table will be added to the Catalog with the
	 * specified number of columns as IntFields indexed on the keyField.
	 */
	...
	/**
	 * A utility method to create a new BTreeFile with no data, with the
	 * specified number of pages, assuming the path does not already exist. If
	 * the path exists, the file will be overwritten. The new table will be
	 * added to the Catalog with the specified number of columns as IntFields
	 ...
	 *
	 * @return a handle to the Thread that will attempt insertion after it has
	 *         been started
	 */
	static class BTreeWriter extends Thread {
		...
		/**
		 * @param tid
		 *            the transaction on whose behalf we want to insert the
		 *            tuple
		 * @param bf
		 *            the B+ tree file into which we want to insert the tuple
		 * @param item
		 *            the key of the tuple to insert
		 * @param count
		 *            the number of times to insert the tuple
		 */
		...
		/**
		 * @return an Exception instance if one occurred while inserting the
		 *         tuple; null otherwise
		 */
	 ...
	 *
	 * @return a handle to the Thread that will attempt to search for tuple(s)
	...
	static class BTreeReader extends Thread {
		...
		/**
		 * @param tid
		 *            the transaction on whose behalf we want to search for the
		 *            tuple(s)
		 * @param bf
		 *            the B+ tree file containing the tuple(s)
		 * @param f
		 *            the field to search for
		 * @param count
		 *            the number of tuples to search for
		 */
	...
	public static class BTreeInserter extends Thread {
		 ...
		 *            the B+ tree file into which we want to insert the tuple
		 * @param tupdata
		 *            the data of the tuple to insert
		 * @param the
		 *            list of tuples that were successfully inserted
		 */
	 ...
	 *
	 * @return a handle to the Thread that will attempt deletion after it has
	 *         been started
	 */
	public static class BTreeDeleter extends Thread {
		...
		/**
		 * @param bf
		 *            the B+ tree file from which we want to delete the tuple(s)
		 * @param the
		 *            list of tuples to delete
		 */
