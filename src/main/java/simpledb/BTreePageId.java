...
/**
 * Unique identifier for BTreeInternalPage, BTreeLeafPage, BTreeHeaderPage and
 * BTreeRootPtrPage objects.
 */
public class BTreePageId implements PageId {
	 ...
	 *         used as a key in a hash table in the BufferPool, for example.)
	 * @see BufferPool
	 */
	public int hashCode() {
	 ...
	 * @return true if the objects are equal (e.g., page numbers, table ids and
	 *         pgcateg are the same)
	 */
