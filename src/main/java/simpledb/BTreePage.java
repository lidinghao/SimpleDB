...
public abstract class BTreePage implements Page {
	 ...
	 * BTreePage. Used to add new, empty pages to the file. Passing the results
	 * of this method to the BTreeInternalPage or BTreeLeafPage constructor will
	 * create a BTreePage with no valid entries in it.
	 *
	 ...
	 * 
	 * @param id
	 *            - the id of the parent of this page
	 * @throws DbException
